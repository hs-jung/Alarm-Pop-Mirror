...
else
{
  ...
  for($i=0;$i<$total_record;$i++)
  {
    ...
    /*
     echo "<p align = \"center\" style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 95px; margin-top: 15px; font-family:'Nanum Gothic'; color: #ffffff;\">".$wp[$i]->station_name."</p>";
     echo  "<div style=\"float: left; width: 50%; height: 80px; margin-right: 0px;\">";
     echo "<img src=\"".$wp[$i]->weather_img_path."\" width=\"72\" style=\"margin-left: 5px;\"/>";
     echo "</div>";
     echo  "<div style=\"float: left; width: 50%; height: 80x; margin-right: 0px;\">";
     ...
     */
       ...
       //echo "<div class=\"carousel\" style=\"width: 190px; height: 130px;\">";
